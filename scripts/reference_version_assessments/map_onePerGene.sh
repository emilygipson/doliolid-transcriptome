#!/bin/bash
#SBATCH --job-name=map_onePerGene
...
#SBATCH --output=/scratch/eeg37520/ReferenceVersionAssessments/onePerGene/mapping/%j_%a.out
#SBATCH --error=/scratch/eeg37520/ReferenceVersionAssessments/onePerGene/mapping/%j_%a.err
...
OUT_DIR="/scratch/eeg37520/ReferenceVersionAssessments/onePerGene/mapping"
...
OUT_BAM="${OUT_DIR}/${SAMPLE}.onePerGene.sorted.bam"
