#!/bin/bash
#SBATCH --job-name=kraken2_transcriptome         # Job name
#SBATCH --partition=batch                       # Partition (queue) name
#SBATCH --ntasks=1                              # Number of tasks
#SBATCH --cpus-per-task=4                       # Number of CPUs (adjust as needed)
#SBATCH --mem=400gb                             # Job memory request
#SBATCH --time=48:00:00                          # Time limit hrs:min:sec
#SBATCH --output=kraken2_transcriptome.%j.out   # Standard output log (%j for job ID)
#SBATCH --error=kraken2_transcriptome.%j.err    # Standard error log
...
# Paths
ASSEMBLY=/scratch/eeg37520/Oct25_transcriptome_v2/Trinity_LongestIso.fasta  # your transcriptome assembly file
DB=/db/kraken2/20250814/core_nt                                               # Kraken2 database
OUTPUT_DIR=/scratch/eeg37520/Oct25_transcriptome_v2/trans_kraken_out
mkdir -p "$OUTPUT_DIR"
