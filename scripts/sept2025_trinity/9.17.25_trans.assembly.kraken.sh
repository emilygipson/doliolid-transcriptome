...
# Paths
ASSEMBLY=/scratch/eeg37520/Sept2025_Trinity/trinity_out.Trinity.fasta  # your transcriptome assembly file
DB=/db/kraken2/20250814/core_nt                                               # Kraken2 database
OUTPUT_DIR=/scratch/eeg37520/Sept2025_Trinity/transKraken_out
mkdir -p "$OUTPUT_DIR"
